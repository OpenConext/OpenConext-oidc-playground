...
export const tokenRequestT = () => (
  <span>The request for a token is performed through a back-channel - e.g. not the browser - by the Relying Party. The<br/>
  authorization code is exchanged for a access token and optional refresh token. The token endpoint is used<br/>
